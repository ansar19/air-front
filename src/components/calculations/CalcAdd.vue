          ...
          <d-form>
            ...
            <d-card-footer class="text-right border-top">
              <div class="d-flex">
                ...
                <d-button class="btn btn-success ml-auto" @click="saveCalc">Сохранить</d-button>
              </div>
            </d-card-footer>
          </d-form>
        </d-card>
...
<script>
import BlastMethod from '@/components/calc-methods/BlastMethod';
import DieselMethod from '@/components/calc-methods/DieselMethod';
import PumpMethod from '@/components/calc-methods/PumpMethod';

export default {
  components: {
    BlastMethod,DieselMethod,PumpMethod
  },
  props: {
    calcList: Array
  },
  data() {
    return {
      releaseSources: [
        ...
        {
          id: 2,
          releaseSourceName: 'CAT 2334 1',
        },
        {
          id: 3,
          releaseSourceName: 'CAT 3334 1',
        },
        {
          id: 4,
          releaseSourceName: 'CAT 4334 1',
        }
      ],
      calcMethods: [
        {
